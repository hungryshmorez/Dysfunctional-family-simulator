...
export function World(props:WorldProps):JSX.Element {
  ...
  const [view,setView]=useState<'home'|'follow'>('home'),[walls,setWalls]=useState(false),[controlsOpen,setControlsOpen]=useState(false);
